...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/vs/install/my_robot_vision"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_robot_vision/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_robot_vision/environment/path.sh"
